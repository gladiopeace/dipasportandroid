...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener, OnGestureListener,
        android.view.GestureDetector.OnDoubleTapListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private com.dipacommerce.dipasport.utils.imagezoom.GestureDetector mScaleDragDetector;
